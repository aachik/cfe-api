...
ActiveRecord::Schema.define(version: 20150419012313) do
  ...
  add_index "employees", ["colleague_id"], name: "index_employees_on_colleague_id", using: :btree
